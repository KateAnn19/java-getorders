package local.mcgeeka.getorders31;
...
//        Agent agentfoo
        ...
        o01.getPaymentsfoo().add(pay1);

        Order o02 = new Order(3000.00,
            500.00,
            c19,
            "SOD");
        o02.getPaymentsfoo().add(pay2);

        Order o03 = new Order(4500.00,
            900.00,
            c07,
            "SOD");
        o03.getPaymentsfoo().add(pay3);
        o03.getPaymentsfoo().add(pay2);

        Order o04 = new Order(2000.00,
            0.00,
            c16,
            "SOD");
        o04.getPaymentsfoo().add(pay4);

        Order o05 = new Order(4000.00,
            600.00,
            c22,
            "SOD");
        o05.getPaymentsfoo().add(pay2);

        Order o06 = new Order(2000.00,
            0.00,
            c12,
            "SOD");
        o06.getPaymentsfoo().add(pay3);

        Order o07 = new Order(3500.00,
            2000.00,
            c02,
            "SOD");
        o07.getPaymentsfoo().add(pay4);

        Order o08 = new Order(2500.00,
            400.00,
            c03,
            "SOD");
        o08.getPaymentsfoo().add(pay1);

        Order o09 = new Order(500.00,
            0.00,
            c23,
            "SOD");
        o09.getPaymentsfoo().add(pay3);

        Order o10 = new Order(4000.00,
            700.00,
            c07,
            "SOD");
        o10.getPaymentsfoo().add(pay4);

        Order o11 = new Order(1500.00,
            600.00,
            c08,
            "SOD");
        o11.getPaymentsfoo().add(pay2);

        Order o12 = new Order(2500.00,
            0.00,
            c25,
            "SOD");
        o12.getPaymentsfoo().add(pay1);
